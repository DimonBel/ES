#!/usr/bin/env python3
"""
Convert all Mermaid diagrams for Lab 4.1 Actuator Control System.
"""
...
def save_mermaid_files(diagrams):
    ...
    diagram_names = [
        ...
        '10_sequence_actuatorcontrol',
        '11_sequence_signalconditioning',
        '12_sequence_display',
        '13_dataflow_input',
        '14_dataflow_processing',
        '15_dataflow_storage',
        '16_dataflow_output',
        '17_dataflow_synchronization',
        '18_sequence_synchronization',
        '19_signal_conditioning_detail',
        '20_input_methods_comparison',
        '21_state_machine',
        '22_timing_diagram',
        '23_hardware_connection',
        '24_system_startup',
        '25_error_handling'
    ]
